...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:appWebRoot+"imagespaceimg/ueditor/add.do"             //图片上传提交地址
       ...
       // ,savePath: [ 'upload']    //图片保存在服务器端的目录， 默认为空， 此时在上传图片时会向服务器请求保存图片的目录列表，
        ...
        ,savePathUrl:appWebRoot+"imagespaceimg/type/list.do" //**** 自定义配置 远程获取上传目录列表,不使用savePath
        ...
        //word转存配置区
        ,wordImageUrl:appWebRoot+"imagespaceimg/ueditor/wordImage/add.do"            //word转存提交地址
        ,wordImagePath:""                          //
