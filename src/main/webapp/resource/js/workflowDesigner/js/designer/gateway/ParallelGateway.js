...
draw2d.ParallelGateway=function(){
	var _url="resource/js/workflowDesigner/css/icons/gateway_parallel.png";
...
draw2d.ParallelGateway.prototype.generateId=function(){
	...
	this.gatewayName='parallel Gateway';
};
...
draw2d.ParallelGateway.prototype.figureDoubleClick=function(){
	...
	nodeid = event.getId();
	openProperties(nodeid,'gateway/parallelGatewayProperties');
};
...
draw2d.ParallelGateway.prototype.toXML=function(){
	...
	var xml='<parallelGateway id="'+this.gatewayId+'" ';
