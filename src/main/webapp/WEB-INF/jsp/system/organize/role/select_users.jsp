...
<%--
	模块：系统管理--组织机构--角色管理--查询未分配用户，分配用户
--%>
	...
	<form   onsubmit="return datagridSearch(this,'${param.rel }_datagrid');" >
		...
		<div class="search-toolbar" >
			<span style="float:left;">
				...
				<shiro:hasPermission name="role:addUser">
					<a class="easyui-linkbutton"  icon="icon-add"	plain="true"
						class="add" href="role/roleAddUsers.do?roleId=${param.roleId }&navTabId=${param.rel}" target="selectedTodo"  warn="至少选择一个用户">批量分配</a>
				</shiro:hasPermission>
				<shiro:hasPermission name="role:hasUser">
					<a class="easyui-linkbutton"  icon="icon-search"	plain="true" 
					 href="role/roleUsers/load.do?roleId=${param.roleId}&rel=${param.rel}" target="navTab"  rel="${param.rel}" title="角色管理_分配管理">查询已有用户</a>
				</shiro:hasPermission>
