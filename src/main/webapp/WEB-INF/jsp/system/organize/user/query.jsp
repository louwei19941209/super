			...
			<span style="float:left;">
				...
				<shiro:hasPermission name="user:add">  
					<a class="easyui-linkbutton"  icon="icon-add"	plain="true"
					  title="添加用户"   href="user/addPage.do?rel=${param.rel}"  target="dialog" width="800" height="400" rel="${param.rel}_add" >添加</a>
				...
				<shiro:hasPermission name="user:delete">  
					<a class="easyui-linkbutton"  icon="icon-remove"	plain="true"
					   	 href="user/delete.do" target="selectedTodo"  title="请谨慎操作！删除用户的同时也会删除跟用户相关的一些数据，如果想保留数据，可以设置禁止用户登录系统代替删除。确定要删除吗?" warn="至少选择一个用户">批量删除</a>
				</shiro:hasPermission>
