...
<div style="width: 600px;margin: 0 auto;">
    ...
    <form action="user/add.do" <%--beforeCallback="encryptePassword"--%> onsubmit="return validateSubmitForm(this)"
          method="post">
        <table class="table table-bordered ">
            <tr>
                ...
                <td>
                    <input type="text" name="userName" class="easyui-validatebox" required="true"
                           data-options="validType:['minlength[3]','alphanumeric']" maxlength="15"/>
            ...
            <tr>
                <th>密码：</th>
                <td>
                    <input type="password" class="easyui-validatebox" required="true" validType="minlength[6]"
                           encryptTo="userPassword" name="userPassword" maxlength="20" value="123456"/>
            ...
            <tr>
                <th>姓名：</th>
                <td>
                    <input type="text" name="trueName" class="easyui-validatebox" required="true"
                           validType="minlength[2]" maxlength="15"/>
            ...
            <tr>
                <th>手机号：</th>
                <td>
                    <input type="text" name="mobilePhoneNumber" class="easyui-validatebox"
                           data-options="validType:['mPhone']" maxlength="11"/>
                </td>
            </tr>
            <%--<tr>
                <th>部门：</th>
                <td>
                    <a href="dept/lookUpPage.do?type=1" lookupGroup="dept" title="部门查询">
                        <input type="text" readonly="readonly" toName="dept.deptName" class="easyui-validatebox"
                               required="true" value='<my:outDeptName id="${param.deptId }"/>'/>
                    </a>
