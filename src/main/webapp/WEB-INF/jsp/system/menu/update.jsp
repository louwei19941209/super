...
<form method="post" action="menu/update/menu.do"  onsubmit="return validateSubmitForm(this)">
		...
		<my:isDeveloper>
			 <div  style="margin-left: 10px;margin-top: 10px;margin-bottom: 5px;">
					...
					<c:url var="url_delxjmenu" value="menu/delete/menu.do" >
			...
			<tr>
				...
				<td>	
					<a href="menu/lookUpPage.do" lookupGroup="menu" title="上级菜单查询" width="500">
						<input type="text" readonly="readonly" class="easyui-validatebox"  required="true"  value="<c:out value="${requestScope.m.superName}"/>"  toName="menu.name" />
					</a>
