    ...
    <body style="background: #f8f8f8;">
        ...
        <article class="hot-product new-detail">
            <div class="header">
                <div class="wrapper limitWidth-percentWidth">
                    ...
                    <p>
                        ...
                        ><a href="<%=path%>/web/excellent/index.do">招商加盟</a>
                        ><a href="javascript:;">优秀加盟商</a>
                    </p>
                    <div>
                        <h4>专访<一></h4>
                    </div>
            ...
            <div class="list-wrap clearfix limitWidth-percentWidth">
                <a href="<%=path%>/web/excellent/index.do">
                    <span>
                ...
                <div class="inner inner-r">
                	...
                	<div class="article_part">
                		<h4>超能鹿战队专访<->${franchisee.title}</h4>
                		<div class="left_words">
                			<p class="left_words_zfrw">【专访人物】:${franchisee.characters}</p>
                			<p class="left_words_rwms">【人物描述】:${franchisee.description}</p>
                			<p class="left_words_rwsf">【人物身份】:${franchisee.identity}</p>
                		</div>
                		<div class="right_img">
                			<img src="${franchisee.image}"/>
                		</div>
                		<div class="artical_content">
                			<p>${franchisee.description}</p>
