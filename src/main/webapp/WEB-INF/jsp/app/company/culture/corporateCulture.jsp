...
<head lang="en">
    ...
    <style>
        ...
        ul.clearfix.qywhlist li {
            width: 50%;
            margin: 20px 0 40px 0;
            position: relative;
        }

        ul.clearfix.qywhlist li:nth-child(even) {
            padding: 0 0 0 170px;
        }

        ul.clearfix.qywhlist li:nth-child(odd) {
            padding: 0 170px 0 0;
            text-align: right;
        }

        .qywhlist li:nth-child(odd) img {
            float: right;
            margin: 0 5%;
            position: absolute;
            top: 0;
        ...
        .qywhlist li:nth-child(even) img {
            float: left;
            margin: 0 5%;
            position: absolute;
            top: 0;
...
<article class="common-page">
    ...
    <section class="limitWidth-percentWidth">
        <div class="wrap-c clearfix wow fadeInUp animated">
            <ul class
                        ="clearfix qywhlist" style="list-style-type: none;">
                ...
                <%--<c:forEach items="${culture.rows}" var="c" varStatus="cou">
                    ...
                    <span class="fl" style="margin: 0px 0px 0px 38px; padding: 0px; width: 116px; height: 120px; float: left; display: block;">
                        <img alt="" src="${c.image}"/>
                            ...
                            <div class="fr" style="margin: 20px 0px 0px; padding: 0px; width: 715px; float: right; display: inline;">
                                <strong style="margin: 0px; padding: 0px; color: rgb(197, 23, 32); line-height: 24px; font-size: 18px;">${c.titile}</strong>
                                <p style="padding: 0px; line-height: 22px; margin-top: 10px; margin-bottom: 0px;">
                ...
                <c:forEach items="${culture.rows}" var="c">
                    <li>
                        <span class="fl">
                           <img alt="" src="${c.image}"/>
                        </span>
                        <div class="fr">
                            <strong style="color: #930000; font-size: 15px;">${c.titile}</strong>
                            <p>
                                    ${c.content}
                                <%--十五年餐饮经营经验的积淀如果不分享不传播永远无法发挥其最大的社会价值，<br/>
                                开放加盟渠道是超能鹿战队的一项重大发展战略，旨在传播优秀的经营理念和经营方法，谋求合作双赢，<br/>将超能鹿战队的社会价值最大化。--%>
