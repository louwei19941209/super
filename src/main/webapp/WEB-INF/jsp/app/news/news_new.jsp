    ...
    <article class="hot-product">
        ...
        <div class="product_slider limitWidth-percentWidth">
        	<div class="slider slider_one_big_2">
		        ...
		        <div>
		        	<img src="<%=path%>/assets/imgs/qyfc/fc1.png"/>
		        </div>
				<div>
					<img src="<%=path%>/assets/imgs/qyfc/fc2.png"/>
				</div>
				<div>
					<img src="<%=path%>/assets/imgs/qyfc/fc3.png"/>
				</div>
				<div>
					<img src="<%=path%>/assets/imgs/qyfc/fc4.png"/>
				</div>
				<div>
					<img src="<%=path%>/assets/imgs/qyfc/fc5.png"/>
				</div>
				<div>
					<img src="<%=path%>/assets/imgs/qyfc/fc6.png"/>
				</div>
				<div>
					<img src="<%=path%>/assets/imgs/qyfc/fc7.png"/>
				</div>
				<div>
					<img src="<%=path%>/assets/imgs/qyfc/fc9.png"/>
				</div>
				<div>
					<img src="<%=path%>/assets/imgs/qyfc/fc10.png"/>
				</div>
				<div>
					<img src="<%=path%>/assets/imgs/qyfc/fc11.png"/>
				</div>
				<div>
					<img src="<%=path%>/assets/imgs/qyfc/fc12.png"/>
				</div>
				<div>
					<img src="<%=path%>/assets/imgs/qyfc/fc13.png"/>
				</div>
				<div>
					<img src="<%=path%>/assets/imgs/qyfc/fc14.png"/>
				</div>
				<div>
					<img src="<%=path%>/assets/imgs/qyfc/fc15.png"/>
				</div>
				<div>
					<img src="<%=path%>/assets/imgs/qyfc/fc16.png"/>
				</div>
				<div>
					<img src="<%=path%>/assets/imgs/qyfc/fc17.png"/>
				</div>
				<div>
					<img src="<%=path%>/assets/imgs/qyfc/fc18.png"/>
				</div>
				<div>
					<img src="<%=path%>/assets/imgs/qyfc/fc19.png"/>
				</div>
