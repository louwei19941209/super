...
<div class="LoginWrapbg ">
    ...
    <div style="width: 442px; height: 440px; margin: 0 auto; margin-top: -260px;">
        <img src="resource/images/login/images/logo.png" style="margin-left: -63px;"/>
        <div class="welcome">&nbsp;</div>
        <div class="loginBar">

            <div>
                <div style="margin-left: 20px;margin-top: 50px;">
                    <h3>当前登陆用户：<tag:loginTrueName type="trueName"/></h3>
                </div>
                <div style="margin-top: 40px;margin-left: 100px;">
                    <a href="main.do">直接进入</a><a href="login/out.do" style="margin-left: 30px;">注销登陆</a>
                </div>
            </div>
