...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="<%=path%>/resource/images/login/login.css">
    <script src="<%=path%>/resource/js/jquery/jquery-1.10.2.min.js"></script>
    <script src="<%=path%>/resource/js/artDialog/jquery.artDialog.js?skin=default"></script>
    <script src="<%=path%>/resource/js/security/security.js"></script>
    <%--<script src="<%=path%>/resource/js/login.js"></script>--%>
</head>
...
<div class="LoginWrapbg ">
    ...
    <div style="width: 442px; height: 440px; margin: 0 auto; margin-top: -260px;">
        <img src="<%=path%>/resource/images/login/images/logo.png" style="margin-left: -63px;"/>
        ...
        <div class="loginBar">
            ...
            <div id="divcenter_loginin" style="display: none;">
                <div style="margin-left: 80px;margin-top: 40px;">
                    <img src="<%=path%>/resource/images/onload.gif" alt="正在登陆中..." style="margin-left: 40px;"/>
