			...
			<span style="float:left;">
				<%--<a class="easyui-linkbutton clearDgChecked"  icon="icon-redo"	plain="true"  title="清空所有勾选项" >清空勾选</a>--%>
					...
					<a class="easyui-linkbutton" icon="icon-add" plain="true"
                       href="franchisee/addPage.do?rel=${param.rel }" target="dialog" width="1000" height="450"
                       rel="${param.rel }_add" title="添加发展历程">添加</a>

					<a class="easyui-linkbutton" icon="icon-edit" plain="true"
                       href="franchisee/update/page.do?id={id}&rel=${param.rel}" target="dialog" width="1000"
                       height="450" rel="${param.rel}_update" warn="请先选择一条信息" title="编辑系统公告">编辑</a>


					<a class="easyui-linkbutton" icon="icon-remove" plain="true"
                       href="franchisee/delete.do" target="selectedTodo" title="确定要删除吗?" warn="至少勾选一个">批量删除</a>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $('#<%=request.getParameter("rel")%>_datagrid').datagrid({
            nowrap: true,
            url: "franchisee/select/by/page.do",
            columns: [[
