			...
			<span style="float:left;">
				<%--<a class="easyui-linkbutton clearDgChecked"  icon="icon-redo"	plain="true"  title="清空所有勾选项" >清空勾选</a>--%>
					...
					<a class="easyui-linkbutton" icon="icon-add" plain="true"
                       href="ifbbstrategy/addPage.do?rel=${param.rel }" target="dialog" width="1000" height="450"
                       rel="${param.rel }_add" title="添加">添加</a>

					<a class="easyui-linkbutton" icon="icon-edit" plain="true"
                       href="ifbbstrategy/update/page.do?id={id}&rel=${param.rel}" target="dialog" width="1000"
                       height="450" rel="${param.rel}_update" warn="请先选择一条信息" title="编辑">编辑</a>


					<a class="easyui-linkbutton" icon="icon-remove" plain="true"
                       href="ifbbstrategy/delete.do" target="selectedTodo" title="确定要删除吗?" warn="至少勾选一个">批量删除</a>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $('#<%=request.getParameter("rel")%>_datagrid').datagrid({
            nowrap: false,
            url: "ifbbstrategy/select/by/page.do",
            columns: [[
